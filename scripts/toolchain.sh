...
step "[1/24] Create toolchain directory."
rm -rf $BUILD_DIR $TOOLS_DIR
mkdir -pv $BUILD_DIR $TOOLS_DIR
ln -svf . $TOOLS_DIR/usr

step "[2/24] Create the sysroot directory"
...
step "[16/24] Raspberry Pi Linux 4.19.97 API Headers"
