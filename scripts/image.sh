...
echo "$TOOLS_DIR/sbin/mkfs.ext2 -d $ROOTFS_DIR $IMAGES_DIR/rootfs.ext2 $CONFIG_ROOTFS_IMAGE_SIZE" >> $BUILD_DIR/_fakeroot.fs
...
mv $IMAGES_DIR/sdcard.img $IMAGES_DIR/$CONFIG_IMAGE_FILENAME
